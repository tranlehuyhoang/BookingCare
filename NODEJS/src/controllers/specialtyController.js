...
let filterSpecialties = async (req, res) => {
  try {
    let infor = await specialtyService.filterSpecialties(req.body);
    return res.status(200).json(infor);
  } catch (e) {
    console.log(e);
    return res.status(200).json({
...
let updateSpecialtyData = async (req, res) => {
  try {
    let infor = await specialtyService.updateSpecialtyData(req.body);
    return res.status(200).json(infor);
  } catch (e) {
    console.log(e);
    return res.status(200).json({
